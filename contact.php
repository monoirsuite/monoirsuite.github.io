...
define("__TO__", "info@monoirsuite.com");

//Success message
define('__SUCCESS_MESSAGE__', "Mesajınız gönderildi. Yakında cevap vereceğiz. Teşekkür ederiz!");

//Error message 
define('__ERROR_MESSAGE__', "Mesajınız gönderilmedi. Lütfen tekrar deneyin.");

//Messege when one or more fields are empty
define('__MESSAGE_EMPTY_FIELDS__', "Lütfen tüm alanları doldurun.");
...
if(isset($_POST['name']) and isset($_POST['mail']) and isset($_POST['messageForm'])){
    ...
    if($name == '') {
        ...
        <html>
        <head>
          <title>Mail şu kişiden geldi '. $name .'</title>
        </head>
        <body>
          <table style="width: 500px; font-family: arial; font-size: 14px;" border="1">
            <tr style="height: 32px;">
              <th align="right" style="width:150px; padding-right:5px;">Ad:</th>
            ...
            <tr style="height: 32px;">
              <th align="right" style="width:150px; padding-right:5px;">Konu:</th>
              <td align="left" style="padding-left:5px; line-height: 20px;">'. $subjectForm .'</td>
            </tr>
            <tr style="height: 32px;">
              <th align="right" style="width:150px; padding-right:5px;">Mesaj:</th>
